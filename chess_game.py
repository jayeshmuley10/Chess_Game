...
coin_imgs={}
coin_imgs['br1'] = pygame.image.load('black_rook.png')
coin_imgs['bh1'] = pygame.image.load('black_knight.png')
coin_imgs['bb1'] = pygame.image.load('black_bishop.png')
coin_imgs['bq '] = pygame.image.load('black_queen.png')
coin_imgs['bk '] = pygame.image.load('black_king.png')
coin_imgs['bb2'] = pygame.image.load('black_bishop.png')
coin_imgs['bh2'] = pygame.image.load('black_knight.png')
coin_imgs['br2'] = pygame.image.load('black_rook.png')
for i in range(1,9):
    coin_imgs['bp'+str(i)] = pygame.image.load('black_pawn.png')

coin_imgs['wr1'] = pygame.image.load('white_rook.png')
coin_imgs['wh1'] = pygame.image.load('white_knight.png')
coin_imgs['wb1'] = pygame.image.load('white_bishop.png')
coin_imgs['wq '] = pygame.image.load('white_queen.png')
coin_imgs['wk '] = pygame.image.load('white_king.png')
coin_imgs['wb2'] = pygame.image.load('white_bishop.png')
coin_imgs['wh2'] = pygame.image.load('white_knight.png')
coin_imgs['wr2'] = pygame.image.load('white_rook.png')
for i in range(1,9):
    coin_imgs['wp'+str(i)] = pygame.image.load('white_pawn.png')

coin_imgs['   '] = pygame.image.load('blank.png')
